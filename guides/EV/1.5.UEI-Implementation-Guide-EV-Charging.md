...
This document explores two primary use cases for EV charging interactions:
...
Arjun is a sales manager who frequently travels between cities for client meetings. He uses his electric vehicle (EV) for long-distance travel and prefers to plan his charging stops in advance to ensure smooth journeys without delays.

Discovery:

* Arjun identifies suitable charging stations along his planned route using his EV charging app. This discovery is facilitated through Beckn APIs, which provide real-time availability and pricing information.  
* He reviews available time slots, charging speeds, and pricing for different stations that align with his travel schedule.

Order:

* Arjun selects a preferred charging station and time slot (e.g., 2:00 PM - 4:00 PM) through his EV charging app for his afternoon break.  
* His app fetches the details of the selected charger point and time slot. Arjun reviews the charging point details, time slot, and pricing, then proceeds.  
* He receives terms of the reservation on his EV charging app and accepts them.  
* He is prompted to choose a payment option. He chooses to make advance payment through UPI, completes the payment, and places the reservation order.  
* The provider verifies the payment, confirms the reservation, and generates a reservation ID with QR code for the specific time slot.

Fulfillment:

* Arjun drives to the charging station at his reserved time.  
* He uses his EV charging app to scan the QR code or enters his reservation ID to activate his reserved charging point.  
* He plugs the charger into his vehicle and initiates the charging process.  
* He tracks the charging status on his EV charging app while his EV is getting charged.  
* He gets a notification on his EV charging app when the charging stops.  
* Arjun removes the charger from his vehicle, thus ending the charging process.

Post Fulfilment:

* Arjun rates his experience using a 0-5 star rating.
...
Priya is a freelance photographer who travels across the city for various photo shoots and events. She uses her electric vehicle (EV) for her work commute and often needs to charge her vehicle spontaneously based on her battery level and proximity to charging stations.

Discovery:

* During her work day, Priya realizes her vehicle needs charging and looks for suitable charging stations near her current location for immediate use.  
* She identifies a charging station with available slots. This discovery can be facilitated through various methods, including Beckn APIs, Google Maps, or word-of-mouth recommendations.  
* She then proceeds to drive to the charging station.

Order:

* Priya uses her EV charging app to scan the QR code displayed on an available charging point(EVSE) at the charging station.  
* Her EV charging app fetches the details of the charger point. Priya goes through the charging point details and proceeds. She receives terms of the order on her EV charging app.  
...
* Priya plugs the charger into her vehicle and initiates the charging process.  
...
* Priya removes the charger from her vehicle, thus ending the charging process.

Post Fulfilment:

* Priya rates her experience using a 0-5 star rating.
